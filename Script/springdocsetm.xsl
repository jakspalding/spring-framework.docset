            ...
            <TokenIdentifier>
                ...
                <Type>
                    <xsl:choose>
                        ...
                        <xsl:when test="contains(., 'Static variable in')">Field</xsl:when>
                        <xsl:when test="contains(., 'Constructor')">Constructor</xsl:when>
                        ...
                        <xsl:when test="contains(., 'Variable in')">Field</xsl:when>
                        <xsl:when test="contains(., 'Interface in')">Interface</xsl:when>
                        <xsl:when test="contains(., 'Exception in')">Exception</xsl:when>
                        <xsl:when test="contains(., 'Error in')">Error</xsl:when>
                        <xsl:when test="contains(., 'Enum in')">Enum</xsl:when>
                        <xsl:when test="contains(., 'package')">Package</xsl:when>
